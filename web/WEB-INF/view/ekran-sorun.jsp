...
<head>
    ...
    <script>
        function myFunction() {
            var x = document.getElementById("isik-sizma");
...
<body id="top">
    ...
    <section id="clients" class="s-clients">
        ...
        <div class="row section-header" data-aos="fade-up">
            <div class="col-full">
                <h3 class="subhead">Ekran Sorunları</h3>
        ...
        <div class="row clients-outer" data-aos="fade-up">
            <div class="col-full">
                ...
                <button class="btn full-width" href="#0" onclick="myFunction()">Ekran köşesinden ışık sızması bulunuyor</button>

                <div id="isik-sizma" style="display: none" class="container">

                    <h3>Işık Sızması</h3>

                    <aside class="pull-quote">
                        <blockquote>
                            <p>Işık sızması problemlerinde ekran üzerine baskı söz konusudur.Ekran üzerine uygulanan baskı son
                                bulduğunda problem giderilecektir.</p>
                        </blockquote>
                    </aside>

                </div>

                <a class="btn full-width" href="/iletisim" onclick="myFunction2()">Ekran kalitesi yeterli değil</a>

                <a class="btn full-width" href="/iletisim">Ekranda ölü piksel sorunu mevcut</a>
