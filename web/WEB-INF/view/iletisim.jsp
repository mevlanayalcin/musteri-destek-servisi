...
<section id="clients" class="s-clients">
    ...
    <div class="row section-header" data-aos="fade-up">
        <div class="col-full">
            <h3 class="subhead">Yardım</h3>
            <h1 class="display-3">Nasıl bir yardım almak istiyorsunuz ?</h1>
        </div>
    </div>
    <!-- end section-header -->
    <div class="row clients-outer" data-aos="fade-up">
        <div class="col-full">
            <div class="clients" style="margin-left:450px;">
                <div>
                    <a onclick="myFunction2()" title="Bizi Arayın" class="clients__slide" >
                        <img src="${pageContext.request.contextPath}/ekler/images/clients/phone.png"/>
                    </a>
                    <caption>Bizi Arayın</caption>
                </div>


                <div>
                    <a href="/bize-yazin" title="Bize Yazın" class="clients__slide">
                        <img src="${pageContext.request.contextPath}/ekler/images/clients/form.png"/>
                    </a>
                    <caption>Bize Yazın</caption>
                </div>
            ...
            <div id="ara" style="display: none" class="container">
